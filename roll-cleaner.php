...
?>
    ...
    <head>
        ...
        <title>Yak Store | Construction Grade Tools For Any Project</title>
        ...
        <div class="container">
            <div class="row">
                <section class="header" id="about">
                    <div class="ban"> <img class="banner" src="images/yak-construction-products.jpg" alt="YAK Construction Products"> </div>
